...
interactors_enums_linear_write_start() {
        ...
        go)
                ...
                views_write_enums_start_go "$1" "$3"
                if [ $? -ne 0 ]; then
                        return 1
                fi
                ;;
        nim)
                ...
                views_write_enums_start_nim "$1" "$3"
                if [ $? -ne 0 ]; then
                        return 1
                fi
                ;;
        powershell)
                ...
                views_write_enums_start_powershell "$1" "$3"
                if [ $? -ne 0 ]; then
                        return 1
                fi
                ;;
        python)
                ...
                views_write_enums_start_python "$1" "$3"
                if [ $? -ne 0 ]; then
                        return 1
                fi
                ;;
        rust)
                ...
                views_write_enums_start_rust "$1" "$3"
                if [ $? -ne 0 ]; then
                        return 1
                fi
                ;;
        shell)
                ...
                views_write_enums_start_shell "$1" "$3"
                if [ $? -ne 0 ]; then
                        return 1
                fi
                ;;
