...
This generator generates incremental numeric value linearly like
`NAME_1 = 0`, `NAME_2 = 1`, `...`. This is most suited for all definition
identifications.
...
In this `presenters` component, `enums-linear` generator uses the
