...
Failed to Write Special Value for Python's Lowercase.
Unable to Proceed.
Bailing Out...
...
"
        ...
        "$UNICODES_OUTPUT_TYPE_TITLECASE")
                ...
                if [ $? -ne 0 ]; then
                HestiaOS_Print_Error "\
Failed to Write Special Value for Python's Titlecase.
Unable to Proceed.
Bailing Out...
...
"
        ...
        "$UNICODES_OUTPUT_TYPE_UPPERCASE")
                ...
                if [ $? -ne 0 ]; then
                        HestiaOS_Print_Error "\
Failed to Write Special Value for Python's Uppercase.
Unable to Proceed.
Bailing Out...
...
"
        ...
        *)
                HestiaOS_Print_Error "\
Failed to Write Special Value for Python - Unknown Casing.
Unable to Proceed.
Bailing Out...
