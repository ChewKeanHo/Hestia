...
# import dependencies
. "${PROJECT_PATH_ROOT}/presenters/unicodes/casing/write-content/normal/value/main.sh"
...
while IFS="" read -r ____line || [ -n "$____line" ]; do
        ...
        if [ ! "${____direction##*CAPITAL}" = "$____direction" ]; then
                ...
                ____direction="$UNICODES_OUTPUT_TYPE_UPPERCASE"
        elif [ ! "${____direction##*SMALL}" = "$____direction" ] || \
        [ ! "${____direction##*LOWER}" = "$____direction" ]; then
                ____to_case="${____line##*;}"
                ____direction="$UNICODES_OUTPUT_TYPE_LOWERCASE"
        else
