...
ENUMS_LINEAR_SOURCE_PATH="\
${PROJECT_PATH_ROOT}/entities/${ENUMS_LINEAR_PREFIX}/Codes-Endian.txt\
"
...
ENUMS_LINEAR_LIST_NAME="Endian' ID"
...
ENUMS_LINEAR_NAME="Codes-Endian"
...
# in Go, C, Nim, and etc.
ENUMS_LINEAR_UNDERSCORE_NAME="Codes_Endian"
...
ENUMS_LINEAR_UNDERSCORE_LOWERCASE_NAME="codes_endian"
...
ENUMS_LINEAR_UNDERSCORE_UPPERCASE_NAME="CODES_ENDIAN"
