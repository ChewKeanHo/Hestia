...
ENUMS_LINEAR_SOURCE_PATH="${PROJECT_PATH_ROOT}/entities/HestiaKERNEL/${ENUMS_LINEAR_PREFIX}/Encoders.txt"
...
ENUMS_LINEAR_DATA_TYPE_NAME="Encoder"
...
ENUMS_LINEAR_LIST_NAME="Encoders' ID"
...
#   * Shell     - same as C.
ENUMS_LINEAR_NAME_C="Encoders"
ENUMS_LINEAR_NAME_GO="Encoders"
ENUMS_LINEAR_NAME_NIM="Encoders"
ENUMS_LINEAR_NAME_POWERSHELL="Encoders"
ENUMS_LINEAR_NAME_PYTHON="Encoders"
ENUMS_LINEAR_NAME_RUST="Encoders"
ENUMS_LINEAR_NAME_SHELL="Encoders"
