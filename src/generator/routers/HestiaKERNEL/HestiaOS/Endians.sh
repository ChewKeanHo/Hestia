...
ENUMS_LINEAR_SOURCE_PATH="${PROJECT_PATH_ROOT}/entities/HestiaKERNEL/${ENUMS_LINEAR_PREFIX}/Endians.txt"
...
ENUMS_LINEAR_DATA_TYPE_NAME="Endian"
...
ENUMS_LINEAR_LIST_NAME="Endians' ID"
...
#   * Shell     - same as C.
ENUMS_LINEAR_NAME_C="Endians"
ENUMS_LINEAR_NAME_GO="Endians"
ENUMS_LINEAR_NAME_NIM="Endians"
ENUMS_LINEAR_NAME_POWERSHELL="Endians"
ENUMS_LINEAR_NAME_PYTHON="Endians"
ENUMS_LINEAR_NAME_RUST="Endians"
ENUMS_LINEAR_NAME_SHELL="Endians"
