...
ENUMS_LINEAR_SOURCE_PATH="${PROJECT_PATH_ROOT}/entities/${ENUMS_LINEAR_PREFIX}/Codes-Encoder.txt"
...
ENUMS_LINEAR_NAME="Codes-Encoder"
...
# in Go, C, Nim, and etc.
ENUMS_LINEAR_UNDERSCORE_NAME="Codes_Encoder"
...
ENUMS_LINEAR_UNDERSCORE_LOWERCASE_NAME="codes_encoder"
...
ENUMS_LINEAR_UNDERSCORE_UPPERCASE_NAME="CODES_ENCODER"
