...
ENUMS_LINEAR_SOURCE_PATH="\
${PROJECT_PATH_ROOT}/entities/${ENUMS_LINEAR_PREFIX}/Codes.txt\
"
...
# in Go, C, Nim, and etc.
ENUMS_LINEAR_UNDERSCORE_NAME="Codes"
...
ENUMS_LINEAR_UNDERSCORE_LOWERCASE_NAME="codes"
...
ENUMS_LINEAR_UNDERSCORE_UPPERCASE_NAME="CODES"
