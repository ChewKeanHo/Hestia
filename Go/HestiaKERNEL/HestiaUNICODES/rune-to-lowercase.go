...
func HestiaUNICODESRuneToLowercase(cut_count *uint8,
	output_char *[]Rune,
	____codepoint1 Rune,
	____codepoint2 Rune,
	____codepoint3 Rune,
	...
	*cut_count = 0
	...
	if ____lang == "az" || ____lang == "tr" {
		...
		case 0x00CC:
			*cut_count = 1
			*output_char = []Rune{ 0x012F, 0x0307, 0x0300 }
			return 0
		case 0x00CD:
			*cut_count = 1
	...
	if ____codepoint1 >= 65 && ____codepoint1 <= 90 {
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 199 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 300 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 + 207 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 + 213 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 + 10727 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 31 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 6254 }
		return 0
	} else if ____codepoint1 == 7297 {
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 6253 }
		return 0
	} else if ____codepoint1 == 7298 {
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 6244 }
		return 0
	} else if ____codepoint1 >= 7299 && ____codepoint1 <= 7300 {
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 6242 }
		return 0
	} else if ____codepoint1 == 7301 {
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 6243 }
		return 0
	} else if ____codepoint1 == 7302 {
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 6236 }
		return 0
	} else if ____codepoint1 == 7303 {
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 6181 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 + 100 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 + 28 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 - 16 }
		return 0
		...
		*cut_count = 1
		*output_char = []Rune{ ____codepoint1 + 34 }
		return 0
	} else {
		*cut_count = 1
