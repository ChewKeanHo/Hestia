...
pub fn get_languages_list() -> &'static [&'static str] {
	// execute
	return &[
		"aa", // Afar
		"ab", // Abkhazian
		...
		"ba-Cyrl", // Bashkir (Cyrillic)
		"ba-Latn", // Bashkir (Latin)
		"ba", // Bashkir (Cyrillic)
		"bal-Arab", // Baluchi (Arabic)
		...
		"brx-Deva", // Boro | Bodo (Devanagari)
		"brx-Latn", // Boro | Bodo (Latin)
		"brx", // Boro | Bodo (Devanagari)
		"bs-Cyrl", // Bosnian
		"bs-Latn", // Bosnian
		"bs", // Bosnian
		"bss", // Akoose Manenguba
		"byn-Latn", // Bilen, Bilin, Blin
		"byn-Ethi", // Bilen, Bilin, Blin
		"byn", // Bilen, Bilin, Blin
		"bzt", // Brithenig
		"ca", // Catalan | Valencian
		"ce-Arab", // Chechen (Arabic)
		"ce-Cyrl", // Chechen (Cyrillic)
		...
		"dv-Thaa", // Maldivian | Dhivehi (Thaana)
		...
		"ewo", // Ewondo
		"fa", // Persian
		"ff-Adlm", // Fula | Fulani | Fulah (Adlam Pular)
		"ff-Arab", // Fula | Fulani | Fulah (Arabic)
		"ff-Latn", // Fula | Fulani | Fulah (Latin)
		"ff", // Fula | Fulani | Fulah (Adlam Pular)
		"fi", // Finnish
		...
		"hi", // Hindi (Devanagari)
		"hit", // Hittite
		"hnj-Hmng", // Hmong Njua, Mong Leng, Mong Njua (Pahawh Hmong)
		...
		"hnj", // Hmong Njua, Mong Leng, Mong Njua (Pahawh Hmong)
		"ho", // Hiri Motu
		...
		"isv", // Interslavic (Cyrillic)
		"it", // Italian
		"iu-Cans", // Inuktitut (Inuktitut)
		...
		"kaa-Cyrl", // Karakalpak (Cyrillic)
		"kaa-Latn", // Karakalpak (Latin)
		"kaa", // Karakalpak (Cyrillic)
		"kab-Arab", // Kabyle (Arabic)
		"kab-Latn", // Kabyle (Latin)
		...
		"kha-Latn", // Khasi (Latin)
		"kha", // Khasi (Latin)
		"khq-Arab", // Koyra Chiini Songhay (Arabic)
		"khq-Latn", // Koyra Chiini Songhay (Latin)
		"khq", // Koyra Chiini Songhay (Latin)
		"ki", // Kikuyu
		"kj", // Kuanyama
		...
		"kr-Arab", // Kanuri (Arabic)
		"kr-Latn", // Kanuri (Latin)
		"kr", // Kanuri (Arabic)
		"kpe-Kpel", // Kpelle (Kpelle)
		"kpe-Latn", // Kpelle (Latin)
		"kpe", // Kpelle (Latin)
		...
		"mic-Latn", // Mi'kmaq, Micmac (Latin)
		"mic", // Mi'kmaq, Micmac (Latin)
		"mix", // Mixe
		"mk", // Macedonian
		...
		"mni-Mtei", // Meitei | Manipuri (Meitei Mayek)
		"mni", // Meitei | Manipuri (Meitei Mayek)
		"moh", // Mohawk
		...
		"na", // Nauru | Nauruan
		"nah", // Nahuatl | Aztec
		"nan-Hans", // Min Nan Chinese (Simplified)
		"nan-Hant", // Min Nan Chinese (Traditional)
		"nan", // Min Nan Chinese (Simplified)
		"naq", // Nama
		"nb", // Norwegian Bokmål
		"nd", // Northern Ndebele
		"ne", // Nepali
		...
		"oj-Cans", // Ojibwe (Canadian Syllabic)
		"oj", // Ojibwe (Canadian Syllabic)
		"om", // Oromo
		"or-Orya", // Odia (Odia)
		"or-Brah", // Odia (Brahmi)
		"or", // Odia (Odia)
		...
		"os", // Ossetian (Cyrillic)
		"osa-Latn", // Osage (Latin)
		"osa-Osge", // Osage (Osage)
		"osa", // Osage (Osage)
		...
		"yrl", // Nhengatu
		"yua", // Yucatec Maya
		"yue-Hans", // Yue Chinese (Simplified)
		"yue-Hant", // Yue Chinese (Traditional)
		"yue", // Yue Chinese (Simplified)
		"za-Hans", // Zhuang (Simplified)
		"za-Hant", // Zhuang (Traditional)
		"za", // Zhuang (Simplified)
		"zba", // Balaibalan
