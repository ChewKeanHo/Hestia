...
import HestiaUNICODES/rune-to-lowercase
import HestiaUNICODES/rune-to-uppercase
...
proc rune_to_titlecase*(
  ...
  if ____to_titlecase == "":
    return hestiaUNICODESRuneToUppercase(
      cut_count,
      output_char,
      ____codepoint1,
      ____codepoint2,
    ...
    return hestiaUNICODESRuneToLowercase(
      cut_count,
      output_char,
      ____codepoint1,
      ____codepoint2,
