...
while IFS= read -r ____library || [ -n "$____library" ]; do
        ...
        if [ $? -ne 0 ]; then
                ...
                1>&2 printf -- "%s" "\
E: From 'rune_to_titlecase.sh': Failed to Import '${____library}'.
E: Unable to Proceed.
...
${LIBS_HESTIA}/HestiaKERNEL/HestiaUNICODES/rune_to_lowercase.sh
${LIBS_HESTIA}/HestiaKERNEL/HestiaUNICODES/rune_to_uppercase.sh
EOF
IFS="$____old_IFS"
unset ____library ____old_IFS
