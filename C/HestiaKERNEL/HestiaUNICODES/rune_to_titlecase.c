...
#ifndef HESTIAUNICODES_RUNE_TO_TITLECASE
#define HESTIAUNICODES_RUNE_TO_TITLECASE
...
#include "Data.h"
#include "locale-is.c"
#include "rune_to_lowercase.c"
#include "rune_to_uppercase.c"
...
int HestiaUNICODES_rune_to_titlecase(uint8 *cut_count,
	Rune **output_char,
	Rune ____codepoint1,
	Rune ____codepoint2,
	Rune ____codepoint3,
	...
	*cut_count = 0;
	...
	if (
		...
		case 0x0049:
			...
			case 0x0307:
				*cut_count = 2;
				if (____to_titlecase == HestiaBOOLEANS_TRUE) {
...
#endif // HESTIAUNICODES_RUNE_TO_TITLECASE
